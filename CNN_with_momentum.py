...
from utility import getImageData, error_rate, create_weight_and_bias, init_filter
from ANN_with_momentum import HiddenLayer
...
class CNN(object):
    ...
    def fit(self, X, Y, lr=10e-5, mu=0.99, reg=10e-7, decay=0.99999, eps=10e-3, batch_sz=30, epochs=100, show_fig=True):
        ...
        W, b = create_weight_and_bias(M1, K)
